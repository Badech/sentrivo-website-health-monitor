      ...
      <main className="flex-1 p-6 overflow-auto">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h2 className="text-xl font-bold text-foreground">Issues Center</h2>
              <p className="text-sm text-muted-foreground">All detected issues across your monitored sites</p>
            </div>
          ...
          <div className="flex gap-3 mb-6 flex-wrap">
            ...
            <div className="px-4 py-2 rounded-lg border border-critical/20 bg-critical/5 text-sm">
              <span className="text-critical/70">Critical: </span>
              <span className="font-semibold text-critical">3</span>
            </div>
            <div className="px-4 py-2 rounded-lg border border-warning/20 bg-warning/5 text-sm">
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-border bg-muted/30">
                    ...
                    <th className="text-left text-[11px] font-semibold text-muted-foreground uppercase tracking-wider px-5 py-3 hidden md:table-cell">Page</th>
                    <th className="text-left text-[11px] font-semibold text-muted-foreground uppercase tracking-wider px-5 py-3 hidden lg:table-cell">Category</th>
                    <th className="text-left text-[11px] font-semibold text-muted-foreground uppercase tracking-wider px-5 py-3">Severity</th>
                    <th className="text-left text-[11px] font-semibold text-muted-foreground uppercase tracking-wider px-5 py-3 hidden sm:table-cell">Detected</th>
                  </tr>
                </thead>
                      ...
                      <td className="px-5 py-3.5">
                        <div className="flex items-center gap-2.5">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-muted-foreground md:hidden">{issue.page}</p>
                          </div>
                        </div>
                      </td>
